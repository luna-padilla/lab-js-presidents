...
function getNames(presidentsArr) {
  const arrayPresidentNames = presidentsArr.map((president) => president.name);
  return arrayPresidentNames;
}
...
function countYearsInOffice(presidentsArr) {
  const yearsPresidence = presidentsArr.reduce((acc, president) => {
    // president.tookOffice- president.leftOffice===null?0:""
